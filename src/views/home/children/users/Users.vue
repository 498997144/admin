<template>
    <div class="users-container">
        ...
        <!-- 添加用户组件// -->
        <Adduser v-show="addShow" @close="close" ref="addUser" @addSuccess="getData(currentPage)"></Adduser>
        <!-- 编辑用户组件 -->
        <Edituser v-show="editShow" @close="close"  @updateSuccess="getData(currentPage)" ref="editUser" :editData="editData"></Edituser>
    </div>
</template>
...
export default {
    ...
    methods: {
        async getUsers(query = '', pagenum = 1, pagesize = 5) {
